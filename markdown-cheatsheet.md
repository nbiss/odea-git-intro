...
- [Markdown Starter Worksheet](#markdown-starter-worksheet)
  - [Sections](#sections)
  - [Headers](#headers)
- [checkout this nice H1 header](#checkout-this-nice-h1-header)
  - [checkout this nice H2 header](#checkout-this-nice-h2-header)
    - [checkout this nice H3 header](#checkout-this-nice-h3-header)
      - [checkout this nice H4 header](#checkout-this-nice-h4-header)
  - [Quotes](#quotes)
  - [Emphasis](#emphasis)
...
<!-- 
    ...
    # H1 Header 
-->
# checkout this nice H1 header
## checkout this nice H2 header
### checkout this nice H3 header
#### checkout this nice H4 header
...
here's a **super cool** and *special* sentence
...
<https://github.com/eastonco>


[My github!](https://github.com/eastonco)
...
![Connor Easton](https://pbs.twimg.com/profile_images/1172399745794314242/2aGL_6cT_400x400.jpg)
...
<h1>Hello world</h1>
<p>I'm not the best a raw html<\p>
